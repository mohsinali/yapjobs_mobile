class SearchController < ApplicationController
	def list
      ...
      {:current_position => params[:current_position], :distance => params[:distance], :role => params[:role], 
        :hourly_rate => params[:hourly_rate], :contract_type => params[:contract_type], :job_type => params[:job_type], 
        :shift => params[:shift], :page => 1, :size => 20}, :Authorization => Rails.application.config.api_authorization, "Content-Type" => "application/json"}
